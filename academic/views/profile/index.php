...
<div class="page-header">
    ...
    <div class="page-breadcrumb"><a href="<?= aUrl() ?>">Trang chủ</a> / Hồ sơ</div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-borderless table-sm mb-4">
                    <tr><th width="35%">Tài khoản:</th><td><?= htmlspecialchars($user['username']) ?></td></tr>
                    <tr><th>Email:</th><td><?= htmlspecialchars($user['email']) ?></td></tr>
                    <tr><th>Vai trò:</th><td><span class="badge bg-primary"><?= htmlspecialchars($user['role_name']) ?></span></td></tr>
                </table>
                <form method="post" action="<?= aUrl('profile') ?>">
                    <input type="hidden" name="action" value="update_email">
                    <div class="mb-3">
                        <label class="form-label">Cập nhật Email</label>
                        <input type="email" name="email" class="form-control" required value="<?= htmlspecialchars($user['email']) ?>">
                    </div>
                    <button type="submit" class="btn btn-primary"><i class="bi bi-save me-1"></i>Lưu Email</button>
                </form>
            </div>
        </div>
    </div>
