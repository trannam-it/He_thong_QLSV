...
<div class="page-header">
    ...
    <div class="page-breadcrumb"><a href="<?= lUrl() ?>">Trang chủ</a> / Hồ sơ</div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-borderless table-sm mb-4">
                    ...
                    <tr><th>Vai trò:</th><td><span class="badge bg-success">Thủ thư</span></td></tr>
                </table>
                <form method="post" action="<?= lUrl('profile') ?>">
