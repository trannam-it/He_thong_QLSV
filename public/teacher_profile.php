...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $sql = "UPDATE lecturers SET phone = ?, email = ? WHERE lecturer_id = ?";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ssi", $phone, $email, $lecturer['lecturer_id']);
...
<head>
    ...
    <title>Thông tin cá nhân - Teacher</title>
...
<!-- Sidebar -->
<aside class="sidebar">
    <a href="teacher.php" class="sidebar-brand">
    ...
    <ul class="sidebar-menu">
        <li class="sidebar-menu-item">
            <a href="teacher.php" class="sidebar-menu-link">
        ...
        <li class="sidebar-menu-item">
            <a href="teacher_profile.php" class="sidebar-menu-link active">
    ...
    <div class="content-wrapper">
        ...
        <div class="page-header">
            ...
            <div class="page-breadcrumb">
                <a href="teacher.php">Trang chủ</a> / Thông tin cá nhân
            </div>
        </div>
                ...
                <div class="content-card">
                    <div class="content-card-header">
                        <h5 class="content-card-title">
                            <i class="bi bi-person-badge me-2"></i>Thông tin giảng viên
                        </h5>
                    </div>
                        ...
                        <form method="POST" action="teacher_profile.php">
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" value="<?= htmlspecialchars($lecturer['lecturer_code']) ?>" disabled>
                                    <small class="text-muted">Không thể thay đổi</small>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Họ và tên</label>
                                    <input type="text" class="form-control" value="<?= htmlspecialchars($lecturer['full_name']) ?>" disabled>
                                    <small class="text-muted">Không thể thay đổi</small>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" value="<?= htmlspecialchars($lecturer['degree']) ?>" disabled>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Khoa</label>
                                    <input type="text" class="form-control" value="<?= htmlspecialchars($lecturer['faculty_name']) ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="email" class="form-control" value="<?= htmlspecialchars($lecturer['email']) ?>" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label"><span class="text-danger">*</span> Số điện thoại</label>
                                    <input type="text" name="phone" class="form-control" value="<?= htmlspecialchars($lecturer['phone']) ?>" pattern="[0-9]{10}" required>
